...
<head>
    ...
    <title>BusGo Employee - <?php echo $pageTitle ?? 'Dashboard'; ?></title>
...
<body>
<div class="d-flex">
    <div id="sidebar" class="bg-success text-white p-3" style="width: 240px; min-width: 240px;">
        <div class="text-center mb-4">
            <div class="fw-bold fs-4">BusGo</div>
            <small class="text-white-50">Employee Panel</small>
        </div>
