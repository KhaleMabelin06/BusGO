        ...
        <div class="modal-content">
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="btnadd" class="btn btn-success">Add Reservation</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="btnstatus" class="btn btn-success btn-sm">Update</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0"><i class="bi bi-ticket-detailed me-2 text-success"></i>Reservation List</h5>
