<?php
    ...
    $totalCustomers    = $conn->query("SELECT COUNT(*) AS cnt FROM ccm_tbl_users WHERE role = 'customer'")->fetch_assoc()['cnt'];
?>
...
<div class="row g-3 mb-4">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="fs-4 fw-bold"><?php echo $totalReservations; ?></div>
                </div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-4">
        <div class="card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="bg-info text-white rounded p-3"><i class="bi bi-hourglass-split fs-4"></i></div>
                <div>
    ...
    <div class="col-sm-6 col-lg-4">
        <div class="card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="bg-secondary text-white rounded p-3"><i class="bi bi-people fs-4"></i></div>
                <div>
                    <div class="text-muted small">Registered Customers</div>
                    <div class="fs-4 fw-bold"><?php echo $totalCustomers; ?></div>
                </div>
            </div>
        </div>
    </div>
