        ...
        <div class="modal-content">
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="btnadd" class="btn btn-primary">Add Schedule</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0"><i class="bi bi-calendar-week me-2 text-primary"></i>Schedule List</h5>
